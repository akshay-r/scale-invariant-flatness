...
from tensorflow_networks.lenet import LeNet
...
for b in batch_size:
    ...
    for r in range(reps):
        ...
        model = LeNet(session=sess, n_classes=n_classes, include_bias=False)
        ...
        sharpness[b].append((sp_norm)/(2+2*model.get_loss_value(train_x, train_y)))

import pickle
with open('mnist_conv_test_acc.pkl','wb') as f:
    pickle.dump(test_acc, f)

with open('mnist_conv_sharpness.pkl','wb') as f:
